...
def create_new_source_in_dirs(tmp_o,tmp_n):
    bs.login()
    for i in range(len(res) - 1 ):
        fields="date,close,volume,pctChg,open"
        ...
        result.pctChg.plot(figsize=(16,8))
...
def timeseting():
    ...
    if tm_str=='20-00':
        writeee()
    threading.Timer(60,timeseting).start()
timeseting()
